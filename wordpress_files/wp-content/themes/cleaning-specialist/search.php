...
if(true===get_theme_mod( 'cleaning_specialist_enable_page_title',true)) :
    do_action('cleaning_specialist_get_page_title',false,false,true,false);
endif;
                    ...
                    <div class="row">
                        <?php
                            if('right'===esc_html(get_theme_mod('cleaning_specialist_blog_sidebar_layout','right'))){
                                ?>
                                    <div id="post-wrapper" class="col-md-9">
                                        <div class="search-content">
                                            <h1 class="page-search"><?php printf( esc_html__( /* translators: %s: Search query */ 'Search Results for: %s','cleaning-specialist'),'<span>' .get_search_query() . '</span>' ); ?> </h1>
                                        </div>
                                        <?php
                                            if(have_posts())
                                            {
                                ...
                                <div id="post-wrapper" class="col-md-9">
                                    <div class="search-content">
                                        <h1 class="page-search"><?php printf( esc_html__('Search Results for: %s','cleaning-specialist'),'<span>' .get_search_query() . '</span>' ); ?> </h1>
                                    </div>
                                    <?php
                                        if(have_posts())
                                        {
